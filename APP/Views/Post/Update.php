    ...
    <div class="container post container3">
        <div class="row">
            <form method="post">
                ...
                <input type="text" name="title" class="form-control title" placeholder="Titre" value='<?= $article->title."\n"; ?>'>
                ...
                <textarea name='chapo' class="form-control chapo" aria-label="With textarea"><?= $article->chapo."\n"; ?></textarea>
                <?php if (!empty($message['chapo'])) echo $message['chapo']."\n"; ?>

                <textarea name='content' class="form-control content" aria-label="With textarea"><?= $article->content."\n"; ?></textarea>
